...
local clockCircleColor = {0.8,0.8,0.8,1}
local clockMarkColor = {0.3,0.3,0.8,1}
local clockNumberkColor = {0.5,0.5,1,1}
local clockArrowkColor = {1,1,0,1}
local fontSize = 50
...
setLayerTranslation(layer,screenWidth/2,screenHeight/2)
...
--text color
setDefaultFillColor(layer, 7, clockNumberkColor[1], clockNumberkColor[2], clockNumberkColor[3], clockNumberkColor[4])
...
setLayerTranslation(hourLayer,screenWidth/2,screenHeight/2)
--setLayerOrigin(hourLayer,screenWidth/2,screenHeight/2)
local minuteLayer = createLayer()
setLayerTranslation(minuteLayer,screenWidth/2,screenHeight/2)
--setLayerOrigin(minuteLayer,screenWidth/2,screenHeight/2)
local secondLayer = createLayer()
setLayerTranslation(secondLayer,screenWidth/2,screenHeight/2)
